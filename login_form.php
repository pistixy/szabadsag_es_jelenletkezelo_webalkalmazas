...
<head>
    ...
    <link href="https://idp.sze.hu/idp/bootstrap/css/bootstrap.css" rel="stylesheet">
    <link href="https://idp.sze.hu/idp/css/regstyle.css" rel="stylesheet">
</head>
<body>
    <div class="loginbox">
        <div class="logoline">
        ...
        <div class="innerbox">
            ...
            <form action="login.php" method="post">
                ...
                <p class="reminder">  <a class="newreg" href="https://user.sze.hu/main/lostpassword" target="_blank"> Elfelejtette jelszavát? - Forgot account? </a> / <a class="newreg" href="https://user.sze.hu/main/regisztracio"> Még nem regisztrált? - Sign Up</a> </p>
